...
jQuery(async () => {
    ...
    async function initializeExtension() {
        ...
        try {
            ...
            const extensionContainer = $(
                '<div id="world-book-generator-container"></div>',
            );
    ...
    const rechargeManager = {
        ...
        init() {
            ...
            this.confirmPaymentButton.on('click', () =>
                this.confirmUserPaymentAndStartPolling(),
            );
        },
        ...
        async confirmUserPaymentAndStartPolling() {
            ...
            try {
                ...
                const confirmResponse = await fetch(
                    `${PAYMENT_SERVER_URL}/api/user-confirm-payment`,
                    {
                        method: 'POST',
                        headers: { 'Content-Type': 'application/json' },
        ...
        async checkPendingOrders() {
            ...
            console.log(
                `[${extensionName}] 检测到 ${pendingOrders.length} 个待处理的支付订单，正在检查...`,
            );
